...
const Sidebar = () => {
  return (
    <div className='bg-[#003A10] min-h-screen pl-[4vw]'>
      <img src={assets.logo} className='mt-5 w-[10vw] sm:w-[100px] hidden sm:block' alt="" />
      <img src= {assets.logo_small} className='mt-5 w-[5vw] sm: w-[40px] mr-5 sm:hidden block' alt="" />
